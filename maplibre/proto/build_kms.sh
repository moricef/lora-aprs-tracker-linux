#!/bin/sh
# Build the KMS/DRM MapLibre display tool on the Pi against the cross-compiled
# ARM64 archives. No LVGL, no GLFW.
set -e
...
g++ -std=gnu++20 -O2 -g -fno-rtti $INC proto_kms_egl.cpp $LIBS $LIBS \
  -o kms_egl \
